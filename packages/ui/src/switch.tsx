...
export const switchStyles = tv({
  ...
  base: "u-peer u-inline-flex u-h-6 u-w-11 u-shrink-0 u-cursor-pointer u-items-center u-rounded-full u-transition-colors disabled:u-cursor-not-allowed disabled:u-opacity-50 data-[state=checked]:u-bg-blue-500 data-[state=unchecked]:u-bg-gray-200",
});
